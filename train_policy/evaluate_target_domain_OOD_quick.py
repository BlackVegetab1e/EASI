...
def main(args):
    ...
    summary_log_dir = args.summary_dir + args.env_id +'/real_domain_test_quick/' +args.tag+'/seed_'+str(args.seed)+'OOD_'+str(args.OOD_rate)
    
    print(summary_log_dir)
...
if __name__ == '__main__':
    ...
    p.add_argument('--actor_weight_dir', type=str, default='logs/Ant/SAC_DR_FT_new/0.25/seed2-20240806-1404/model')
    p.add_argument('--summary_dir', type=str, default='logs/')
    p.add_argument('--tag', type=str, default='SAC_FT_87')
