...
if __name__ == '__main__':
    ...
    p.add_argument('--seed', type=int, default=2, help='随机种子')
    p.add_argument('--summary_dir', type=str, default='logs/', help='log放哪')
    p.add_argument('--expert_weight', type=str, default='logs/Ant/SAC_DR_test/seed2-20240419-1654/final_model/actor.pth', help='用哪个policy控制机器人儿')
    p.add_argument('--trajectory_length', type=int, default=200, help='机器人的一个轨迹有多长,只有ball是500,其他都是200')
    ...
    p.add_argument('--number_of_env', type=int, default=100, help='有多少个并行环境同时给你采集demo')
    p.add_argument('--collect_steps', type=int, default=40000, help='总共采集多少步demo')
    args = p.parse_args()
    collect_demo(args)
