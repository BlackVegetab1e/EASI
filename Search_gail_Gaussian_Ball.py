...
def train_env_policy(gail:GAIL, envs, expert_policy, args):
    ...
    if(args.OOD):
        search_logdir = args.summary_dir+'/'+args.env_id+'/search_gaussian/'+args.tag+'/seed_'+str(args.seed)+'OOD_'+str(args.OOD_rate)+'/'
    else:
...
if __name__ == '__main__':
    ...
    p.add_argument('--expert_weight', type=str, default='logs/BallBalance/SAC_DR/seed0-20240422-1625/final_model/actor.pth')
    p.add_argument('--expert_data', type=str, default='logs/BallBalance/expert/size100000_traj_length200_real_domain_cpu_seed_0.pth')
