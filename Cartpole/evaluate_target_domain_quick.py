...
def main(args):
    ...
    if args.OOD:
        summary_log_dir = args.summary_dir + args.env_id +'/real_domain_test/' +args.tag+'/seed_'+str(args.seed)+'_OOD'+str(args.OOD_rate)
    else:
...
if __name__ == '__main__':
    ...
    p.add_argument('--actor_weight_dir', type=str, default='logs/Cart_pole_50hz_paper/SAC_DR_FT/0.5/seed2-20240805-2136/model')
    p.add_argument('--summary_dir', type=str, default='logs/')
    p.add_argument('--tag', type=str, default='DR_TF')
